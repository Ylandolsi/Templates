// https://github.com/ShahjalalShohag/code-library/blob/main/Strings/String%20Hashing%20With%20Updates%20and%20Reverse.cpp
#include<bits/stdc++.h>
using namespace std;
const int N = 1e5 + 9;
...
using T = array<int, 2>;
const T MOD = {1000000181, 998244353};
const int B1 = get_rand(1252 , 27954253 ) + 161 ; 
const int B2 = get_rand(948 , 7954253 ) + 143 ;
const T p = {B1, B2};
...
// this hash , s[0] + s[1]*B + S[2]*B^2 + S[3]*B^3 + ...
struct Hashing {
  int n;
  string s; // 1 - indexed
